...
/**
 * SqlServerHandler class description.
 *
 * @package    Components
 ...
 * @release    $Revision$
 */
class SqlServerHandler extends \Bridge\Components\Exporter\Database\AbstractDatabaseHandler
{
